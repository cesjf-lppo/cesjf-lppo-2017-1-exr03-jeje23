...
public class NovoVistanteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      Logger.getLogger(NovoVistanteServlet.class.getName()).log(Level.INFO, "POST: " +nome+" "+idade);
       try {
            ...
            Logger.getLogger(NovoVistanteServlet.class.getName()).log(Level.SEVERE, "Erro ao inserir o registro!" +e);
